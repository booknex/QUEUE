...
export interface IStorage {
  ...
  updateWorkSession(id: number, updates: UpdateWorkSession): Promise<WorkSession | undefined>;
...
export class DatabaseStorage implements IStorage {
  ...
  async getAllFiles(companyId?: number): Promise<ClientFile[]> {
    const query = db
      .select({
        ...
        loanType: clientFiles.loanType,
        interestRate: clientFiles.interestRate,
        lenderAName: clientFiles.lenderAName,
        lenderAContact: clientFiles.lenderAContact,
        lenderAPhone: clientFiles.lenderAPhone,
        lenderAEmail: clientFiles.lenderAEmail,
        lenderBName: clientFiles.lenderBName,
        lenderBContact: clientFiles.lenderBContact,
        lenderBPhone: clientFiles.lenderBPhone,
        ...
        ltvPayoffAmount: clientFiles.ltvPayoffAmount,
        fileClosing: clientFiles.fileClosing,
        termOffered: clientFiles.termOffered,
        minCreditScore: clientFiles.minCreditScore,
        minLoanAmount: clientFiles.minLoanAmount,
        highestLtv: clientFiles.highestLtv,
        highestDti: clientFiles.highestDti,
        maxCashout: clientFiles.maxCashout,
        ...
        lenderAPdfName: clientFiles.lenderAPdfName,
        lenderAPdfPath: clientFiles.lenderAPdfPath,
        lenderBPdfName: clientFiles.lenderBPdfName,
        lenderBPdfPath: clientFiles.lenderBPdfPath,
  ...
  async updateWorkSession(id: number, updates: UpdateWorkSession): Promise<WorkSession | undefined> {
    const [updated] = await db
      .update(workSessions)
      .set(updates)
