    ...
    <>
      ...
      {open && (
        <aside
          ...
          className={cn(
            "fixed top-1/2 -translate-y-1/2 w-80 max-h-[90vh] bg-background border rounded-md shadow-xl transition-all duration-300 ease-in-out z-[51] overflow-hidden cursor-pointer pointer-events-auto",
            isNotesOpen ? "left-[calc(50%-21rem-1.25rem)]" : "left-[calc(50%-21rem-21rem)]"
          )}
      ...
      {open && (
        <aside
          ...
          className={cn(
            "fixed top-1/2 -translate-y-1/2 w-80 max-h-[90vh] bg-background border rounded-md shadow-xl transition-all duration-300 ease-in-out z-[51] overflow-hidden cursor-pointer pointer-events-auto",
            isTouchesOpen ? "right-[calc(50%-21rem-1.25rem)]" : "right-[calc(50%-21rem-21rem)]"
          )}
