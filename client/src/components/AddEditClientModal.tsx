    ...
    <>
      ...
      {open && (
        <aside
          ...
          className={cn(
            "fixed top-[40%] -translate-y-[40%] w-[36rem] max-h-[90vh] bg-background border rounded-md shadow-xl transition-all duration-300 ease-in-out z-[51] overflow-hidden cursor-pointer pointer-events-auto",
